...
export const diagnosticSections: DiagnosticSection[] = [
  {
    ...
    questions: [
      ...
      { key: "has_second_nationality", label: "Você possui 2a nacionalidade?", type: "radio", required: true, layout: "full", layoutRow: "has-second-nationality", options: yesNo },
  ...
  },
  {
    ...
    questions: [
      ...
      { key: "has_second_education", label: "Você possui 2a escolaridade ou formação complementar?", type: "radio", required: true, layout: "full", layoutRow: "education-secondary", options: yesNo },
